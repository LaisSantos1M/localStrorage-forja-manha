...
window.onload = function(){
    var storadUser = localStorage.getItem("usuario")
    var user = JSON.parse(storadUser)
...
document.addEventListener("DOMContentLoaded",function(){
    ...
    .then((data) => {
        ...
        produtos.forEach((produto, index) =>{
            ...
            btnAdicionarAoCarrinho.textContent = "Adicionar no carrinho"
